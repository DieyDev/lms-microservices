...
const Footer = () => {
  return (
    <footer className="mt-12 border-t border-slate-200 bg-white pb-8 pt-10 text-slate-700 dark:border-white/10 dark:bg-slate-950/20">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="mb-4 flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-slate-900 dark:text-slate-100">LMS Platform</span>
            </div>
          ...
          <div>
            <h4 className="mb-5 text-sm font-bold text-slate-900 dark:text-slate-100">Học tập</h4>
            <ul className="space-y-3 text-xs font-bold text-slate-700 dark:text-slate-400">
          ...
          <div>
            <h4 className="mb-5 text-sm font-bold text-slate-900 dark:text-slate-100">Hỗ trợ</h4>
            <ul className="space-y-3 text-xs font-bold text-slate-700 dark:text-slate-400">
          ...
          <div>
            <h4 className="mb-5 text-sm font-bold text-slate-800 dark:text-slate-100">Bản tin</h4>
            <div className="flex gap-2">
              <input
                type="text"
                placeholder="Email của bạn"
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs outline-none transition focus:border-primary/40 focus:ring-4 focus:ring-primary/10 dark:border-white/10 dark:bg-white/5 dark:text-slate-100 dark:placeholder:text-slate-500"
              />
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-200 pt-8 md:flex-row dark:border-white/10">
          ...
          <div className="flex gap-6 text-slate-600 dark:text-slate-500">
